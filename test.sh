...
assert 10 'int add1(int a) { return 10; } int main() { return add1(10); }'
assert 10 'int add1(int a) { return a; } int main() { return add1(10); }'
assert 10 'int add1(int a) { return a + 1; } int main() { return add1(9); }'
assert 10 'int add(int a, int b) { return a + b; } int main() { return add(9,1); }'
assert 8 'int sub(int a, int b) { return a - b; } int main() { return sub(9,1); }'
assert 7 'int sub(int a, int b, int c) { return a - b - c; } int main() { return sub(9,1,1); }'
assert 6 'int sub(int a, int b, int c, int d) { return a - b - c - d; } int main() { return sub(9,1,1,1); }'
assert 5 'int sub(int a, int b, int c, int d, int e) { return a - b - c - d - e; } int main() { return sub(9,1,1,1,1); }'
